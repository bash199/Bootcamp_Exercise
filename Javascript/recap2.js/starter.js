...
const getAgencyByName = (agenciesArr, name) => {
  // ourCarMarket.sellers
  return agenciesArr.filter(el => {
    return el.agencyName ===  name
  })
};
// console.log( getAgencyByName(ourCarMarket.sellers, 'CaMax'));
//* 2. getAgencyById
//? @param {array}   - agenciesArr
//? @param {string}  - id - agency id.
//? @return {string} - agencyId
const getAgencyById = function (agenciesArr, id) {
  return agenciesArr.find(el => {
...
const getAllAgenciesNameAndId = (agenciesArr) => {
  return agenciesArr.map(({agencyId,agencyName}) => {
    return {
       agencyName,
      agencyId
    }
  ...
  let a = []
   agenciesArr.forEach(el=>{
    ...
    for (let i = 0; i < keys.length; i++) {
      for (const iterator of el.cars[keys[i]]) {
        a.push(iterator)
      }
    }
  })
...
// console.log( getCarsToBuyByModel(ourCarMarket.sellers,'Toyota'))
...
// console.log(getCarsToBuyByModelAndAgencyId(ourCarMarket.sellers,'X5'));
//!------------- Customers Getters ----------------------
//* 8. getCustomerByName
...
//* beacuae if there were an identical client so it returns both of them and not one of them.
const getCustomerByName = (customersArr, name) => {
  return customersArr.filter(el => {
    return el.name ===  name
  })
};
// console.log(getCustomerByName(ourCarMarket.customers,'Lilah Goulding'))
//* 9. getCustomerById
//? @param {array}  - customersArr
...
const deleteCarFromAgency = (agencyObject, carNumber) => {
  ...
  return agencyObject.cars
};
// console.log(deleteCarFromAgency(ourCarMarket.sellers[0],'kAnv-'))
...
// console.log(decOrIncCashOfAgency(ourCarMarket.sellers[0],31459))
...
// console.log(decOrIncCreditOfAgency(ourCarMarket.sellers[0],-500000))
//* 17. setCarToCustomer
...
// console.log(setCarToCustomer(ourCarMarket.customers[0],{name: 'Fiat Punto', year: 2012,price: 30000,carNumber: '69di3',ownerId: 'HgTre758'}));
...
// console.log(decOrIncCashOfCustomer(ourCarMarket.customers[0],35000));
//!---------------- Hard ----------------------
...
//! At the end of the exercise, (theoretically) if you had the ability to change the original carMarket object to another form, what would it be?
